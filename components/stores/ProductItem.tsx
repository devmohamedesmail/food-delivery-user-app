        ...
        <View className="relative w-28 h-28">
          {item.image ? (
            ...
            <View className="flex justify-center items-center p-2">
              <FontAwesome6 name="image" size={70} color="gray" />
            </View>
          )}
        ...
        <View className="flex-1 p-3">
          ...
          {quantity === 0 ? (
            <TouchableOpacity
              ...
              className="rounded-full py-3 px-4 flex-row items-center justify-center bg-primary "
            >
            ...
            <View className="flex-row items-center justify-between bg-gray-100 rounded-full w-44 py-1 px-2">
              <TouchableOpacity
