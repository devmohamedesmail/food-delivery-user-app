    ...
    <>
      {data && data.length > 0 ? (
        <View className="px-5 mb-6 py-3">
          <View
            className={`flex-row justify-between items-center mb-4 ${i18n.language === "ar" ? "flex-row-reverse" : "flex-row"}`}
          >
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            router.push({
                              ...
                              params: {
                                storeItem: JSON.stringify(product.store),
                              },
                            })
                          }
                        >
                          ...
                          >
                            ...
                            <View className="p-4">
                              ...
                              <View className="flex flex-row">
                                ...
                                <Text className="mx-2 text-xl text-primary font-bold">
                                  {product.sale_price} {config.CurrencySymbol}
                                </Text>
                              </View>
                              ...
                              <View className="flex-row items-center justify-between mt-2">
                                <TouchableOpacity
                                  ...
                                  style={{ backgroundColor: "#fd4a12" }}
                                  onPress={() =>
                                    handleAddToCart(product, product.store)
                                  }
                                >
                                  <Ionicons
                                    name="add"
